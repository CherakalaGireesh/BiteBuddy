CREATE TABLE How_It_Works_Slides (
                                     slide_id NUMBER GENERATED BY DEFAULT AS IDENTITY START WITH 1 INCREMENT BY 1 PRIMARY KEY,
                                     slideshow_id NUMBER NOT NULL,
                                     image_url VARCHAR2(255) NOT NULL, -- Image or icon for each step
                                     caption VARCHAR2(200) NOT NULL, -- Step title
                                     description CLOB, -- Detailed step description
