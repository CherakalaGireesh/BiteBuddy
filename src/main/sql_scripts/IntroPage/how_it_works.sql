...
CREATE OR REPLACE TRIGGER Updatehow_it_worksTimestamp
BEFORE UPDATE ON how_it_works
                  FOR EACH ROW
BEGIN
...
INSERT INTO how_it_works (image_name, caption, description, status, user_action, additional_info, tip)
VALUES
(
    'browse-menu.jpeg',
    'Browse Menu',
