CREATE TABLE our_story_parts (
                          id NUMBER GENERATED ALWAYS AS IDENTITY START WITH 1 INCREMENT BY 1 PRIMARY KEY,
                          image_base_path VARCHAR2(100) DEFAULT 'D:\\PROJECTS\\BiteBuddyImages\\AboutUs\\OurStoryParts',
...
CREATE OR REPLACE TRIGGER UpdateOurStoryPartsTimestamp
    BEFORE UPDATE ON our_story_parts
                      FOR EACH ROW
BEGIN
    :NEW.updated_at := CURRENT_TIMESTAMP;
END;

INSERT INTO our_story_parts (image_name, caption, description)
