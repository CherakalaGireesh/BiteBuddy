CREATE TABLE OurPromise (
                            id NUMBER GENERATED ALWAYS AS IDENTITY START WITH 1 INCREMENT BY 1 PRIMARY KEY,
                            image_base_path VARCHAR2(100) DEFAULT 'D:\\PROJECTS\\BiteBuddyImages\\AboutUs\\OurPromise',
...
CREATE OR REPLACE TRIGGER UpdateOurPromiseTimestamp
    BEFORE UPDATE ON OurPromise
                      FOR EACH ROW
BEGIN
...
INSERT INTO OurPromise (image_name, caption, description)
